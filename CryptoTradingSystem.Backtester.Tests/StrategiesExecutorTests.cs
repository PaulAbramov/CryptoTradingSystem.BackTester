...
public class StrategiesExecutorTests
{
	...
	//
	// 	// Act
	// 	StrategiesExecutor.SetStatisticsClosedTrades(
	// 		strategy,
	// 		candleClose,
	// 		tradeType);
	// 	Assert.Multiple(
	...
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.ProfitLoss,
	// 				Is.EqualTo(expectedStrategyAnalytics.ProfitLoss),
	// 				"ProfitLoss");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.ReturnOnInvestment,
	// 				Is.EqualTo(expectedStrategyAnalytics.ReturnOnInvestment),
	// 				"ReturnOnInvestment");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.TradesAmount,
	// 				Is.EqualTo(expectedStrategyAnalytics.TradesAmount),
	// 				"TradesAmount");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.AmountOfWonTrades,
	// 				Is.EqualTo(expectedStrategyAnalytics.AmountOfWonTrades),
	// 				"AmountOfWonTrades");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.WonTradesPercentage,
	// 				Is.EqualTo(expectedStrategyAnalytics.WonTradesPercentage),
	// 				"WonTradesPercentage");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.AmountOfLostTrades,
	// 				Is.EqualTo(expectedStrategyAnalytics.AmountOfLostTrades),
	// 				"AmountOfLostTrades");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.LostTradesPercentage,
	// 				Is.EqualTo(expectedStrategyAnalytics.LostTradesPercentage),
	// 				"LostTradesPercentage");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.SharpeRatio,
	// 				Is.EqualTo(expectedStrategyAnalytics.SharpeRatio),
	// 				"SharpeRatio");
	// 			Assert.That(
	// 				strategy.StrategyAnalytics.SortinoRatio,
	// 				Is.EqualTo(expectedStrategyAnalytics.SortinoRatio),
	// 				"SortinoRatio");
